...
func (hs *HTTPServer) registerRoutes() {
	...
	r.Group("/api", func(apiRoute routing.RouteRegister) {
		...
		apiRoute.Get("/plugins/:pluginId/settings", authorize(reqSignedIn, ac.EvalPermission(plugins.ActionSettingsRead, pluginIDScope)), routing.Wrap(hs.GetPluginSettingByID))
