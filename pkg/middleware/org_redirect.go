...
func OrgRedirect(cfg *setting.Cfg, orgService org.Service) web.Handler {
	return func(res http.ResponseWriter, req *http.Request, c *web.Context) {
		...
		cmd := org.SetUsingOrgCommand{UserId: ctx.UserId, OrgId: orgId}
		if err := orgService.SetUsingOrg(ctx.Req.Context(), &cmd); err != nil {
			if ctx.IsApiRequest() {
