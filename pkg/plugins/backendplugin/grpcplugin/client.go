...
func NewBackendPlugin(newAccessHandlerFn acplugins.AccessHandlerFactory, pluginID, executablePath string) backendplugin.PluginFactoryFunc {
	return newPlugin(newAccessHandlerFn, PluginDescriptor{
		pluginID:       pluginID,
