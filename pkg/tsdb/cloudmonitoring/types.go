...
type (
	cloudMonitoringQueryInterface interface {
		executeQuery(ctx context.Context, tsdbQuery *tsdb.TsdbQuery, e *CloudMonitoringExecutor) (*tsdb.QueryResult, cloudMonitoringResponse, error)
		unmarshalResponse(res *http.Response) (cloudMonitoringResponse, error)
