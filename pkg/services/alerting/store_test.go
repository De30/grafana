...
func TestIntegrationAlertingDataAccess(t *testing.T) {
	...
	t.Run("Can set new states", func(t *testing.T) {
		...
		alertQuery := models.GetAlertsQuery{DashboardIDs: []int64{testDash.Id}, PanelId: 1, OrgId: 1, User: &user.SignedInUser{OrgRole: user.RoleAdmin}}
	...
	t.Run("Viewer can read alerts", func(t *testing.T) {
		setup(t)
		viewerUser := &user.SignedInUser{OrgRole: user.RoleViewer, OrgId: 1}
	...
	t.Run("Alerts with same dashboard id and panel id should update", func(t *testing.T) {
		...
		t.Run("Alerts should be updated", func(t *testing.T) {
			query := models.GetAlertsQuery{DashboardIDs: []int64{testDash.Id}, OrgId: 1, User: &user.SignedInUser{OrgRole: user.RoleAdmin}}
	...
	t.Run("Multiple alerts per dashboard", func(t *testing.T) {
		...
		t.Run("Should save 3 dashboards", func(t *testing.T) {
			...
			queryForDashboard := models.GetAlertsQuery{DashboardIDs: []int64{testDash.Id}, OrgId: 1, User: &user.SignedInUser{OrgRole: user.RoleAdmin}}
