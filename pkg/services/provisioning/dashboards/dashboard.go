...
type DashboardProvisionerFactory func(string, dashboards.Store, bool) (DashboardProvisioner, error)
...
func New(configDirectory string, store dashboards.Store, legacyAlertingIsEnabled bool) (DashboardProvisioner, error) {
	...
	fileReaders, err := getFileReaders(configs, logger, store, legacyAlertingIsEnabled)
	if err != nil {
...
func getFileReaders(configs []*config, logger log.Logger, store dashboards.Store, legacyAlertingIsEnabled bool) ([]*FileReader, error) {
