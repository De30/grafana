...
// Summarizer returns a func that takes raw bytes representing a Service
...
func Summarizer() kindsys.Summarizer {
	...
	// in the Service kind declaration.

	// handleSummary is "passthrough" for the Service kind. If the Go compiler
