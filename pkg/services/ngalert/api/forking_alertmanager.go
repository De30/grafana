...
func (f *AlertmanagerApiHandler) handleRouteTestTemplateEval(c *models.ReqContext, body apimodels.TestTemplatePayload) response.Response {
	return f.GrafanaSvc.RouteTestTemplateEval(c, body)
}
