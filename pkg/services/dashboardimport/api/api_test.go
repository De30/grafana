...
func TestImportDashboardAPI(t *testing.T) {
	t.Run("Quota not reached, schema loader service disabled", func(t *testing.T) {
		...
		importDashboardAPI := New(service, quotaServiceFunc(quotaNotReached), schemaLoaderService, nil, actest.New().WithDisabled())
	...
	t.Run("Quota reached", func(t *testing.T) {
		service := &serviceMock{}
		schemaLoaderService := &schemaLoaderServiceMock{}
		importDashboardAPI := New(service, quotaServiceFunc(quotaReached), schemaLoaderService, nil, actest.New().WithDisabled())
