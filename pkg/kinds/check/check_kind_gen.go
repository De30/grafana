...
const rootrel string = "kinds/structured/check"

// TODO standard generated docs
type Kind struct {
	lin    thema.ConvergentLineage[*Check]
	jcodec vmux.Codec
	valmux vmux.ValueMux[*Check]
...
func NewKind(rt *thema.Runtime, opts ...thema.BindOption) (*Kind, error) {
	...
	tsch, err := thema.BindType[*Check](cursch, &Check{})
	if err != nil {
		// Should be unreachable, modulo bugs in the Thema->Go code generator
		return nil, err
	}

	k.jcodec = vmux.NewJSONCodec("check.json")
