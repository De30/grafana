...
const rootrel string = "kinds/structured/service"

// TODO standard generated docs
type Kind struct {
	lin    thema.ConvergentLineage[*Service]
	jcodec vmux.Codec
	valmux vmux.ValueMux[*Service]
...
func NewKind(rt *thema.Runtime, opts ...thema.BindOption) (*Kind, error) {
	...
	tsch, err := thema.BindType[*Service](cursch, &Service{})
	if err != nil {
		// Should be unreachable, modulo bugs in the Thema->Go code generator
		return nil, err
	}

	k.jcodec = vmux.NewJSONCodec("service.json")
...
// TODO standard generated docs
func (k *Kind) ConvergentLineage() thema.ConvergentLineage[*Service] {
	return k.lin
}

// JSONValueMux is a version multiplexer that maps a []byte containing JSON data
// at any schematized dashboard version to an instance of Service.
//
// Validation and translation errors emitted from this func will identify the
// input bytes as "dashboard.json".
//
// This is a thin wrapper around Thema's [vmux.ValueMux].
func (k *Kind) JSONValueMux(b []byte) (*Service, thema.TranslationLacunas, error) {
	return k.valmux(b)
}
...
// service declaration in .cue files.
...
// representing the static properties declared in the service kind.
//
