...
A mute timing is a recurring interval of time when no new notifications are generated or sent. After you create a mute timings, add it to a notification policy.
