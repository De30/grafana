...
| `type`               | string                        | **Yes**  | Plugin type. Possible values are: `app`, `datasource`, `panel`, `secretsmanager`.                                                                                                                                                                                                                                                                                                                       |
...
| `id`      | string | **Yes**  |                                                                      |
| `name`    | string | **Yes**  |                                                                      |
| `type`    | string | **Yes**  | Possible values are: `app`, `datasource`, `panel`, `secretsmanager`. |
| `version` | string | **Yes**  |                                                                      |
...
| `isCreateAction` | boolean | No       | Whether the page is used to create a new resource.                                                                                                                                              |
| `name`           | string  | No       |                                                                                                                                                                                                 |
| `path`           | string  | No       | Used for app plugins.                                                                                                                                                                           |
| `role`           | string  | No       | Possible values are: `Admin`, `Editor`, `Viewer`.                                                                                                                                               |
| `type`           | string  | No       | Possible values are: `dashboard`, `page`, `panel`, `datasource`, `secretsmanager`.                                                                                                              |
...
| `urlParams`    | [object](#urlparams)[]  | No       | Add URL parameters to a proxy route                                                                                                       |
...
| Property  | Type   | Required | Description                |
| --------- | ------ | -------- | -------------------------- |
| `content` | string | No       | Value of the URL parameter |
| `name`    | string | No       | Name of the URL parameter  |
