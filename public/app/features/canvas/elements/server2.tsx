...
import { GrafanaTheme2, VizOrientation, TimeRange, dateMath, dateTime, LoadingState, EventBus } from '@grafana/data';
import { BarGaugeDisplayMode, useStyles2 } from '@grafana/ui';
import { DimensionContext, ScalarDimensionConfig } from 'app/features/dimensions';
import { ScalarDimensionEditor } from 'app/features/dimensions/editors';
import { BarGaugePanel } from 'app/plugins/panel/bargauge/BarGaugePanel';
...
const Server2Display: FC<CanvasElementProps<WindTurbineConfig, WindTurbineData>> = (props) => {
  ...
  //   const valueProps = VizRepeaterRenderValueProps<FieldDisplay, DisplayValueAlignmentFactors>;
...
export const server2Item: CanvasElementItem<any, any> = {
  id: 'server2',
  name: 'Server2',
  description: 'Server with status',

  display: Server2Display,
