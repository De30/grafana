...
import { createOrganization, validatOrganization } from './state/actions';
...
export const NewOrgPage: FC<Props> = ({ navModel, createOrganization, validatOrganization }) => {
                ...
                <Field label="Organization name" invalid={!!errors.name} error={errors.name && errors.name.message}>
                  <Input
                    ...
                    {...register('name', {
                      ...
                      validate: async (orgName) => await validatOrganization(orgName),
                    })}
                  />
                </Field>
