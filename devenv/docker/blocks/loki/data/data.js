...
async function main() {
  for (let step = 0; step < 300; step++) {
    ...
    lokiSendLogLine(timestampMs, JSON.stringify(item), {job:'grafana', source: 'data', service: 'app_1'});
    lokiSendLogLine(timestampMs, logFmtLine(item), {job:'loki', source: 'data', service: 'app_2'});
  }
}
