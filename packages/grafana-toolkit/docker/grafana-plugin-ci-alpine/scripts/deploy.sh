...
apk add --no-cache curl nodejs-current npm yarn build-base openssh git-lfs perl-utils coreutils python3
...
current_dir=$PWD
if [ -d "/usr/local/grafana-toolkit" ]; then
...
GOOGLE_SDK_VERSION=359.0.0
GOOGLE_SDK_CHECKSUM=b84828fbd7c2c842edf3df4d514f01f7b6a9e587fa5b563b0f1dde4587574b1b
...
echo "Verifying Google SDK checksum..."
